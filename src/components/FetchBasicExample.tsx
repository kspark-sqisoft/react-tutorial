...
const FetchBasicExample = () => {
  ...
  const fetchData = useCallback(async (signal?: AbortSignal) => {
    try {
      ...
      if (!response.ok) throw new Error("네트워크 통신 에러");
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-100 to-gray-200 p-6">
      <div className="w-full max-w-xl bg-white rounded-2xl shadow-xl p-6 space-y-6">
        ...
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-2xl font-bold text-gray-800">Fetch Posts</h1>
...
export default FetchBasicExample;
